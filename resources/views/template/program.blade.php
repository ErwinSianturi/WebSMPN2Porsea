...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mx-auto py-0">
                    ...
                    <a href="program" class="nav-item nav-link active">Program</a>
    ...
    <div class="jumbotron jumbotron-fluid position-relative"
        ...
        <div class="container text-center my-5 py-5 position-relative">
            <h1 class="text-white display-1 mb-1 font-weight-bold text-shadow text-uppercase">Program</h1>
            <h1 class="display-3 text-uppercase text-white mb-3"><?php echo $sekolah->nama_sekolah; ?></h1>
        </div>
    </div>
    <!-- Header End -->
    <center>
        <h1 class="display-5">Prestasi Akademik</h1>
    </center>
    <!-- Feature Start -->
    @foreach ($prestasi as $key => $item)
        <div class="container-fluid py-5">
            <div class="col-12">
                <div class="row justify-content-between shadow-card">
                    <div class="col-lg-7 mb-5 mb-lg-0 semua-jus">
                        <div class="section-title position-relative mb-2">
                            <h1 class="display-5 ">{{ $item->nama_siswa }}</h1>
                        </div>
                        <p class="mb-4 pb-2 text-muted">{!! $item->keterangan !!}</p>
                    </div>
                    <div class="col-lg-5 d-flex justify-content-lg-end justify-content-center">
                        <div class="position-relative h-100">
                            <img class="img-fluid " src="{{ asset('foto/' . $item->foto) }}"
            ...
            <div class="row mx-0 justify-content-center mb-2">
                <div class="col-lg-8">
                    <div class="section-title text-center position-relative">
                        <h1 class="display-4">Kegiatan Sekolah</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                @foreach ($kegiatan as $kegiatana)
                    <div class="col-lg-4 col-md-6 col-sm-12 mt-2">
                        <div class="card h-100 shadow">
                            <div class="card-header">
                                <img src="{{ asset('foto/' . $kegiatana->foto) }}" class="card-img-top" alt="..."
                                    style="height: 200px; object-fit: cover;">
                            </div>
                            <div class="card-body semua-jus">
                                <h5 class="card-title mb-1">{{ $kegiatana->nama_kegiatan }}</h5>
                                <p class="card-text mb-1">{!! $kegiatana->keterangan !!}</p>
                            </div>
                            <div class="card-footer text-center">
                                @if ($kegiatana->video == '' || $kegiatana->video == null)
                                @else
                                    <a target="_blank" href="{{ asset('video/' . $kegiatana->video) }}"
                                        class="btn btn-primary rounded">Lihat/Unduh Video</a>
                                @endif
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row">
                @foreach ($guru->where('jabatan', 'Guru') as $gurus)
                    <div class="col-lg-4 col-md-6 col-sm-12 mt-2">
                        <div class="card h-100 shadow">
                            <div class="card-header">
                                <img src="{{ asset('foto/' . $gurus->foto) }}" class="card-img-top" alt="..."
                                    style="height: 300px; object-fit: cover;">
                            </div>
                            <div class="card-body">
                                <h5 class="card-title mb-1">{{ $gurus->nama_lengkap }}</h5>
                                <p class="card-text mb-1">{{ $gurus->tanggal_lahir }}</p>
                                <p class="card-text mb-1">{{ $gurus->mata_pelajaran }}</p>
                                <p class="card-text mb-1">{{ $gurus->alamat }}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
    ...
    <div class="container-fluid position-relative overlay-top"
        ...
        <div class="container mt-5 pt-5">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12 mb-5 semua-jus">
                    <a href="index" class="navbar-brand">
                        <h1 class="mt-n2 text-uppercase text-white"><i
                                class="fa fa-book-reader mr-3"></i>{!! $sekolah->nama_sekolah !!}</h1>
                    </a>
