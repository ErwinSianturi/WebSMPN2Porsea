                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="text-right">
                                    <a href="/pengumuman" class="btn btn-warning btn-sm"><i
                                            class="fa-solid fa-arrow-rotate-left"></i> Back</a>
                                </div>
                            </div>
                            <form class="needs-validation" novalidate action="/pengumuman/{{ $pengumuman->id }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="isi" id="isi" class="form-control @error('isi') is-invalid @enderror" cols="10"
                                                    rows="5" placeholder="Isi Pengumuman" required>{{ old('isi', $pengumuman->isi) }}</textarea>
                                                @error('isi')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="kategori" id="kategori"
                                                    ...
                                                    <option value="umum"
                                                        ...
                                                        Umum</option>
                                                    <option value="psb"
                                                        {{ old('kategori', $pengumuman->kategori) === 'psb' ? 'selected' : '' }}>
                                                        PSB</option>
                                                </select>
                                                @error('kategori')
                                                    <span class="invalid-feedback text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="foto"
                                                    ...
                                                    accept="image/*">
                                                @if ($pengumuman->foto)
                                                    <img src="{{ asset('foto/' . $pengumuman->foto) }}"
                                                        alt="Old Image" width="100">
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                @if ($pengumuman->file)
                                                    <img src="{{ asset('file/' . $pengumuman->file) }}"
                                                        alt="Old Image">
                                                @endif
                                            </div>
                                        </div>
